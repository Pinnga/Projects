...
class Fraction:
  ...
  #Performance Analysis: __lt__(self,other)
  #Performance: O(1)
  #this is because the function performs a fixed number of opetations that are not dependent on the size of any input.
  def __lt__(self, other):
    ...
    x = self.__n * other.__d
    y = self.__d * other.__n
    
    if self.__d * other.__d > 0:
      if x < y:
        return True
      else:
        return False
  ...
  #Performance Analysis: __gt__(self,other)
  #Performance: O(1)
  #this is because the function performs a fixed number of opetations that are not dependent on the size of any input.
  ...
  #Performance Analysis: __eq__(self,other)
  #Performance: O(1)
  #this is because the function performs a fixed number of opetations that are not dependent on the size of any input.
...
if __name__ == '__main__':
  ...
  Arr = []
  Arr.append(Fraction(5,2))
  Arr.append(Fraction(43,12))
  Arr.append(Fraction(12,4))
  Arr.append(Fraction(4,12))
  Arr.append(Fraction(35,22))
  Arr.append(Fraction(15,22))
  Arr.append(Fraction(5,23))
  Arr.append(Fraction(14,2))
  


  Frac_Tree = Binary_Search_Tree()
  for val in Arr:
    Frac_Tree.insert_element(val)
  print(Arr)
  print(Frac_Tree.to_list())
